 ...
 */
function blocFaceAFace(a, b, passage, quartDeTour, table) {
...
function enBlocs(unites, disposition, passage, groupement) {
    ...
    for (const table of tables.slice(tableIndex))
        blocs.push(blocSimple(table));
    return blocs;
}
/**
...
export function elevationDebout(m) {
 ...
 */
export function coureursArche(nombre = 5) {
