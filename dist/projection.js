...
export function besoinLumens(surfaceM2) {
    const s = Math.max(surfaceM2, 0);
    const centaine = (n) => Math.round(n / 100) * 100;
 ...
 */
export function lireLumens(libelle) {
 ...
 */
export function dcpPourCible(lumensCible, max = 5) {
