 ...
 */
export function decalageVoisin(m, cote, dims) {
...
export const dessinable = (m, cote, choix) => pieceDeCote(m, cote, choix) !== null;
/** Le fichier du demi-mur pour ce type. `null` si le modèle n'en a pas. */
export const pieceDemiMur = (m, type) => vue3d(m).pieceDemiMur?.[type] ?? null;
