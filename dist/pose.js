...
export const MODES_POSE = ["remplir", "une_fois", "mosaique"];
...
export const PORTEES = ["pan", "zone", "tente"];
...
export function porteesPour(zone) {
 ...
 */
export function plageTaille(mode) {
    if (mode === "remplir")
        return null; // il couvre : rien à régler
